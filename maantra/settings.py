"""
Django settings for maantra project.
...
SECRET_KEY = 'django-insecure-p$_ur2**x#yf$5auvdu6p2vjy%wa2ht33ydzwh!(h0t&1ect9_'
...
WSGI_APPLICATION = 'maantra.wsgi.application'
...
#     ],
#     'SERIALIZERS': {
#         'current_user': 'user.serializers.SocialUserCreateSerializer'
#     },
# }
...
DJOSER = {
    ...
    'SERIALIZERS': {
        ...
        'user_create_password_retype':'user.serializers.UserSerializer',
    },
    'LOGIN_FIELD':'email',
